...
,	function (
	...
	, link: function (scope, element, attrs) {
			...
			$scope.timeline = {};
			$scope.timeline.notch = {};
			$scope.timeline.series = [];
		  ...
		  Timeline.prototype = _.extend(Timeline.prototype, {
		    ...
		    render : function() {
		      ...
		      if (!$(".TS-card_active").is("*")) this.chooseNext.click();
		  ...
		  Bar.prototype = _.extend(Bar.prototype, {
		    ...
		    render : function(){
		      ...
		      for (var i = 0; i < intervals.length; i++) {
		        ...
		        $scope.timeline.notch.years.push({
		        	  'timestamp': intervals[i].timestamp
		        	, 'human'    : intervals[i].human
		        	, 'style'    : {'left': bounds.project(intervals[i].timestamp, 100) + "%"}
		        });
		      }
		    }
		  });
		  ...
		  Series.prototype = _.extend(Series.prototype, {
		    ...
		    render : function(e){
		      ...
		      $scope.timeline.series.push(this);
